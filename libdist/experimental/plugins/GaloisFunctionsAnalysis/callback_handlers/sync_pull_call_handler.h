    ...
    virtual void run(const MatchFinder::MatchResult &Results) {
      ...
      for(auto i : info->reductionOps_map){
        for(auto j : i.second){
          ...
          auto syncPull_lhs_argument = Results.Nodes.getNodeAs<clang::MemberExpr>(str_lhs_argument);
          auto syncPull_memExpr = Results.Nodes.getNodeAs<clang::MemberExpr>(str_memExpr);
          auto syncPull_insideEdgeLoop = Results.Nodes.getNodeAs<clang::Stmt>(str_modified_insideEdgeLoop);
          auto syncPull_outsideEdgeLoop = Results.Nodes.getNodeAs<clang::Stmt>(str_modified_outsideEdgeLoop);
