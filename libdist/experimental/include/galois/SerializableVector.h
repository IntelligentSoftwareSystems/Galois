 ...
 * @section Description
 *
 * Wrapper around vector to make it copyable (mainly used for serialization).
 * Should only be used if vector is going to remain a static size after
 * initialization.
 *
