...
template <bool is_single, bool use_ccode, bool use_pcode, bool use_local_graph,
          bool do_local_counting, bool is_clique>
void EmbeddingList<is_single, use_ccode, use_pcode, use_local_graph,
                   do_local_counting, is_clique>::allocate(Graph* graph,
                                                           unsigned max_size,
                                                           unsigned max_degree,
                                                           int num_patterns) {
  global_graph = graph;
  ...
  if (use_local_graph) {
    // std::cout << "allocating local_graph, length=" << length << ",
    // max_level=" << max_level << "\n";
  ...
  local_counters.resize(
      num_patterns); // for local counts of tri, 4-cycle and 4-clique
  allocated = true;
}
...
template <bool is_single, bool use_ccode, bool use_pcode, bool use_local_graph,
          bool do_local_counting, bool is_clique>
void EmbeddingList<is_single, use_ccode, use_pcode, use_local_graph,
                   do_local_counting, is_clique>::init_vertex(const VertexId
                                                                  vid) {
...
template <bool is_single, bool use_ccode, bool use_pcode, bool use_local_graph,
          bool do_local_counting, bool is_clique>
void EmbeddingList<
    is_single, use_ccode, use_pcode, use_local_graph, do_local_counting,
    is_clique>::construct_local_graph_from_vertex(const VertexId vid) {
...
template <bool is_single, bool use_ccode, bool use_pcode, bool use_local_graph,
          bool do_local_counting, bool is_clique>
void EmbeddingList<is_single, use_ccode, use_pcode, use_local_graph,
                   do_local_counting, is_clique>::init_edge(const SEdge& edge) {
...
void EmbeddingList<
    is_single, use_ccode, use_pcode, use_local_graph, do_local_counting,
    is_clique>::construct_local_graph_from_edge(const SEdge& edge) {
...
template <bool is_single, bool use_ccode, bool use_pcode, bool use_local_graph,
          bool do_local_counting, bool is_clique>
void EmbeddingList<is_single, use_ccode, use_pcode, use_local_graph,
                   do_local_counting, is_clique>::update_egonet(unsigned
                                                                    level) {
...
template class EmbeddingList<true, true, false, false, false,
                             true>; // K-cliques
template class EmbeddingList<true, true, false, true, false,
                             true>; // K-cliques using local graph
template class EmbeddingList<true, true, true, false, false,
                             false>; // Subgraph Listing
template class EmbeddingList<false, true, true, false, false, false>; // Motif
template class EmbeddingList<false, true, true, false, true,
                             false>; // Motif using formula
