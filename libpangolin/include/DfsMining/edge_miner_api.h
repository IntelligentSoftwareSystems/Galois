...
public:
	...
	static inline bool toExtend(unsigned n, unsigned pos) {
		return true;
	}

	static inline bool toAdd(BaseEdgeEmbeddingList &emb_list, Pattern &pattern, unsigned threshold) {
	...
	static inline unsigned getPattern(unsigned n, unsigned i, VertexId dst, const BaseEdgeEmbedding &emb, unsigned pos) {
		return 0;
	}
