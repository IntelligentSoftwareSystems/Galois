...
void batch_get_mirror_node_pull_flag_cuda(struct CUDA_Context* ctx,
                                          unsigned from_id, uint8_t* v);
void batch_get_mirror_node_pull_flag_cuda(
    struct CUDA_Context* ctx, unsigned from_id, uint8_t* v,
    size_t* v_size, DataCommMode* data_mode);
...
void batch_set_mirror_node_pull_flag_cuda(
    struct CUDA_Context* ctx, unsigned from_id, uint8_t* v, DataCommMode data_mode);
void batch_set_node_pull_flag_cuda(struct CUDA_Context* ctx, unsigned from_id,
                                   uint8_t* v, size_t v_size,
                                   DataCommMode data_mode);
void batch_add_mirror_node_pull_flag_cuda(struct CUDA_Context* ctx, unsigned from_id,
                                   uint8_t* v, size_t v_size,
                                   DataCommMode data_mode);
void batch_add_node_pull_flag_cuda(struct CUDA_Context* ctx, unsigned from_id,
                                   uint8_t* v, size_t v_size,
                                   DataCommMode data_mode);
void batch_min_mirror_node_pull_flag_cuda(struct CUDA_Context* ctx, unsigned from_id,
                                   uint8_t* v, size_t v_size,
                                   DataCommMode data_mode);
...
void LiveUpdate_allNodes_cuda(unsigned int& DGAccumulator_accum,
                              uint32_t local_k_core_num,
                              struct CUDA_Context* ctx);
void LiveUpdate_masterNodes_cuda(unsigned int& DGAccumulator_accum,
                                 uint32_t local_k_core_num,
                                 struct CUDA_Context* ctx);
void LiveUpdate_nodesWithEdges_cuda(unsigned int& DGAccumulator_accum,
                                    uint32_t local_k_core_num,
                                    struct CUDA_Context* ctx);
