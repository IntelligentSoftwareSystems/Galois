...
struct ResetGraph {
  ...
  void static go(Graph& _graph) {
    ...
    #endif
    galois::do_all(_graph.allNodesRange().begin(), _graph.allNodesRange().end(), ResetGraph{ &_graph }, galois::loopname("ResetGraph"), galois::numrun(_graph.get_run_identifier()));
  }
...
#endif
galois::do_all(_graph.allNodesRange().begin(), _graph.allNodesRange().end(), FirstItr_PageRank{alpha,tolerance,&_graph}, galois::loopname("PageRank"), galois::numrun(_graph.get_run_identifier()), galois::write_set("reduce", "this->graph", "struct PR_NodeData &", "struct PR_NodeData &" , "residual", "float" , "add",  "0"));
...
galois::runtime::reportStat("(NULL)", "NUM_WORK_ITEMS_" + (_graph.get_run_identifier()), _graph.allNodesRange().end() - _graph.allNodesRange().begin(), 0);
...
struct PageRank {
  ...
  void static go(Graph& _graph) {
    ...
    #endif
    galois::do_all(_graph.allNodesRange().begin(), _graph.allNodesRange().end(), PageRank{ tolerance, alpha, &_graph }, galois::loopname("PageRank"), galois::write_set("reduce", "this->graph", "struct PR_NodeData &", "struct PR_NodeData &" , "residual", "float" , "add",  "0"), galois::numrun(_graph.get_run_identifier()));
