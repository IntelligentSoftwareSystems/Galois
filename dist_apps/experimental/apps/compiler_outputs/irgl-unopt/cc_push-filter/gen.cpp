...
#endif
galois::do_all(_graph.allNodesRange().begin(), _graph.allNodesRange().end(), FirstItr_ConnectedComp{&_graph}, galois::loopname("ConnectedComp"), galois::numrun(_graph.get_run_identifier()), galois::write_set("reduce", "this->graph", "struct NodeData &", "struct NodeData &" , "comp_current", "unsigned int" , "min",  ""));
...
struct ConnectedComp {
  ...
  void static go(Graph& _graph){
    ...
    #endif
    galois::do_all(_graph.allNodesRange().begin(), _graph.allNodesRange().end(), ConnectedComp (&_graph), galois::loopname("ConnectedComp"), galois::write_set("reduce", "this->graph", "struct NodeData &", "struct NodeData &" , "comp_current", "unsigned int" , "min",  ""), galois::numrun(_graph.get_run_identifier()));
