...
void PageRankSanityCheck_cuda(float& _max_value, float& _min_value,
                              float& _sum_value, float& _sum_residual,
                              unsigned int& num_residual_over_tolerance,
                              float& _max_residual, float& _min_residual,
