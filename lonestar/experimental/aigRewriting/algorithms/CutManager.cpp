...
CutManager::CutManager( aig::Aig & aig, int K, int C, int nThreads, bool compTruth ) : 
...
void CutManager::computeCuts( CutPool * cutPool, CutList * cutList, AuxTruth * auxTruth, int nodeId, int lhsId, int rhsId, bool lhsPolarity, bool rhsPolarity) {
...
void CutManager::computeCutsRec( aig::GNode node, CutPool * cutPool, CutList * cutList, AuxTruth * auxTruth ) {
...
inline bool CutManager::processTwoCuts( CutPool * cutPool, CutList * cutList, AuxTruth * auxTruth, Cut * lhsCut, Cut * rhsCut, bool lhsPolarity, bool rhsPolarity, int nodeId, int & currentNumCuts ) {
...
inline bool CutManager::cutFilter( CutPool * cutPool, CutList * cutList, Cut * resCut, int & currentNumCuts ) {
...
void CutManager::computeTruth( AuxTruth * auxTruth, Cut * resCut, Cut * lhsCut, Cut * rhsCut, bool lhsPolarity, bool rhsPolarity ) {
...
int CutManager::getNWords() {
	return this->nWords;
}

int CutManager::getNThreads() {
	return this->nThreads;
}

bool CutManager::getCompTruthFlag() {
	return this->compTruth;
}

long double CutManager::getKcutTime() {
	return this->kcutTime;
}

void CutManager::setKcutTime( long double time ) {
	this->kcutTime = time;
}
