...
void NPNManager::getPermutationsRec( char ** pRes, int nFact, int n, char Array[] ) {
...
void NPNManager::truthPermuteInt( int * pMints, int nMints, char * pPerm, int nVars, int * pMintsP ) {
...
unsigned NPNManager::truthPermute( unsigned Truth, char * pPerms, int nVars, int fReverse ) {
...
int NPNManager::getNFuncs() {
	return this->nFuncs;
}

unsigned short * NPNManager::getCanons() {
	return this->canons;
}

char * NPNManager::getPhases() {
	return this->phases;
}

char * NPNManager::getPerms() {
	return this->perms;
}

char * NPNManager::getPractical() {
	return this->practical;
}

unsigned char * NPNManager::getMap() {
	return this->map;
}

unsigned short * NPNManager::getMapInv() {
	return this->mapInv;
}

char ** NPNManager::getPerms4() {
	return this->perms4;
}
