 ...
 *  */
const unsigned short NPNMananger::rewritePracticalClasses[136] = 
{
...
char ** NPNMananger::getPermutations( int n ) {
...
void NPNMananger::getPermutationsRec( char ** pRes, int nFact, int n, char Array[] ) {
...
void NPNMananger::truthPermuteInt( int * pMints, int nMints, char * pPerm, int nVars, int * pMintsP ) {
...
unsigned NPNMananger::truthPermute( unsigned Truth, char * pPerms, int nVars, int fReverse ) {
...
unsigned NPNMananger::truthPolarize( unsigned uTruth, int Polarity, int nVars ) {
...
void NPNMananger::initializePractical() {
...
void ** NPNMananger::arrayAlloc( int nCols, int nRows, int Size ) {

    void ** pRes;
    char * pBuffer;
    int i;
    assert( nCols > 0 && nRows > 0 && Size > 0 );
    pBuffer = (char *) malloc( sizeof( char ) * ( nCols * (sizeof(void *) + nRows * Size) ) );
    pRes = (void **)pBuffer;
...
int NPNMananger::factorial( int n ) {
...
int NPNMananger::getNFuncs() {
	return this->nFuncs;
}

unsigned short * NPNMananger::getCanons() {
	return this->canons;
}

char * NPNMananger::getPhases() {
	return this->phases;
}

char * NPNMananger::getPerms() {
	return this->perms;
}

char * NPNMananger::getPractical() {
	return this->practical;
}

unsigned char * NPNMananger::getMap() {
	return this->map;
}

unsigned short * NPNMananger::getMapInv() {
	return this->mapInv;
}

char ** NPNMananger::getPerms4() {
	return this->perms4;
}
