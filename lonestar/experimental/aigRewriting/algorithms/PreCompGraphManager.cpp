...
PreCompGraphManager::PreCompGraphManager( NPNManager & npnManager ) : npnManager( npnManager ), table( npnManager.getNFuncs() ), classes( 222 ) {
...
ForestNode * PreCompGraphManager::addForestNode( ForestNode * p0, ForestNode * p1, int fExor, int Level, int Volume ) {
...
void PreCompGraphManager::addForestNodeToTable( unsigned uTruth, ForestNode * node ) {
...
DecEdge PreCompGraphManager::processNodeRec( ForestNode * node, DecGraph * decGraph ) {
...
ForestNode * PreCompGraphManager::getForest() {
	return this->forest;
}
