...
/**
 * Splits the given std::string in a vector of std::strings at each occurrence of a given delimiter.
 *
...
/**
 * Splits the given std::string at each occurrence of a given regex-based delimiter and returns a vector of std::strings.
 *
 ...
 */
//std::vector<std::string> regex_split(const std::string & s, std::string rgx_str = "\\s+");
