...
struct OPENCL_Context {
    ...
    void init(int num_items, int num_inits) {
        ...
        init_all.set_arg(2, sizeof(cl_int) * m_graph.num_nodes() , wl);  //added this line
        wb_kernel.set_arg(2, sizeof(cl_int), &num_items);
        kernel.set_arg(2, sizeof(cl_int) * m_graph.num_nodes(), wl); //added this one
