...
struct SSSP {
  ...
  void static go(Graph& _graph){
    ...
    do{
      ...
      #endif
      galois::do_all(_graph.begin(), _graph.end(), SSSP { &_graph }, galois::loopname("sssp"), galois::write_set("sync_pull", "this->graph", "struct NodeData &", "struct NodeData &", "dist_current" , "unsigned long long"));
      _graph.sync_pull<SyncerPull_0>();
