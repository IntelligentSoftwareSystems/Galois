...
double calModularityDelay(Graph& graph, CommArray& c_info, CommArray& c_update, double& e_xx, double& a2_x, double& constant_for_second_term, largeArray& local_target) {
