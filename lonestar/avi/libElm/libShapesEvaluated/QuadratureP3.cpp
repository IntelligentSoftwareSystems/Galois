...
const double Tet_4Point::BulkWeights []    =    {1./24.,
						 1./24.,
						 1./24.,
						 1./24.};

const double Tet_4Point::FaceMapCoordinates[] = {2./3., 1./6.,
						 1./6., 2./3.,
						 1./6., 1./6.}; 
...
const Quadrature* const Tet_4Point::Bulk = 
  new Quadrature(Tet_4Point::BulkCoordinates, 
		 Tet_4Point::BulkWeights, 3, 4);

const Quadrature* const Tet_4Point::FaceOne =
  new Quadrature(Tet_4Point::FaceMapCoordinates, 
		 Tet_4Point::FaceOneShapeCoordinates, 
		 Tet_4Point::FaceOneWeights, 2, 3, 3);

const Quadrature* const Tet_4Point::FaceTwo = 
  new Quadrature(Tet_4Point::FaceMapCoordinates, 
		 Tet_4Point::FaceTwoShapeCoordinates, 
		 Tet_4Point::FaceTwoWeights, 2, 3, 3);

const Quadrature* const Tet_4Point::FaceThree = 
  new Quadrature(Tet_4Point::FaceMapCoordinates, 
		 Tet_4Point::FaceThreeShapeCoordinates, 
		 Tet_4Point::FaceThreeWeights, 2, 3, 3);

const Quadrature* const Tet_4Point::FaceFour = 
  new Quadrature(Tet_4Point::FaceMapCoordinates, 
		 Tet_4Point::FaceFourShapeCoordinates, 
		 Tet_4Point::FaceFourWeights, 2, 3, 3);


const double Tet_11Point::BulkCoordinates[] = 
  {1./4., 1./4., 1./4.,
   11./14., 1./14., 1./14.,
   1./14., 11./14., 1./14.,
   1./14., 1./14., 11./14.,
...
const Quadrature* const Tet_11Point::Bulk = 
new Quadrature(Tet_11Point::BulkCoordinates, 
	       Tet_11Point::BulkWeights, 3, 11);
...
const Quadrature* const Tet_15Point::Bulk = 
new Quadrature(Tet_15Point::BulkCoordinates, 
	       Tet_15Point::BulkWeights, 3, 15);
// Sriramajayam
