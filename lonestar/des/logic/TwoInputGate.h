/** TwoInputGate is basic structure of a two input gates -*- C++ -*-
 * @file
 * @section License
 *
...
class TwoInputGate: public BaseLogicGate<TwoInputGateTraits::N_OUT, TwoInputGateTraits::N_IN> {
private:
  typedef BaseLogicGate<TwoInputGateTraits::N_OUT, TwoInputGateTraits::N_IN> SuperTy;
