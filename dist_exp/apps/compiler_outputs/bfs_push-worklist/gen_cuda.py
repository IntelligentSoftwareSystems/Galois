...
Kernel("BFS", [G.param(), ('unsigned int', '__nowned'), ('unsigned int *', 'p_dist_current')],
[
...
Kernel("BFS_cuda", [('struct CUDA_Context *', 'ctx')],
[
CDecl([("dim3", "blocks", "")]),
CDecl([("dim3", "threads", "")]),
CBlock(["kernel_sizing(blocks, threads)"]),
...
Invoke("BFS", ("ctx->gg", "ctx->nowned", "ctx->dist_current.data.gpu_wr_ptr()", "ctx->in_wl", "ctx->out_wl")),
CBlock(["check_cuda_kernel"], parse = False),
