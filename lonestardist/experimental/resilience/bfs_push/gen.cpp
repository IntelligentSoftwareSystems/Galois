...
struct InitializeGraph {
  ...
  void operator()(GNode src) const {
    ...
    // Need for resilience. If host with src crashes, src will not propagate the
    // value to it's neighbors. sdata.dist_old = (graph->getGID(src) ==
    // local_src_node) ? 0 : local_infinity;
