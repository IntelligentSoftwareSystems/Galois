...
mf_parameter parse_command_line(int argc, char **argv, char *Y_src, char *X1_src, char *X2_src, char *Yt_src)
{
...
void run_mf_train(mf_parameter param, smat_t &Y, smat_t &X1, smat_t &X2, smat_t &Yt) {
	srand48(0UL);
...
int main(int argc, char* argv[]){
	...
	puts("");
	smat_t Y,X1,X2,Yt;
	mf_parameter param = parse_command_line(argc, argv, Y_src, X1_src, X2_src, Yt_src); 
