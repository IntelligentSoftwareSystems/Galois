...
enum {L2R_BILINEAR_LS=0, L2R_BILINEAR_LR=1, L2R_BILINEAR_SVC=2, 
	L2R_BILINEAR_LS_FULL=10, L2R_BILINEAR_LS_FULL_WEIGHTED=11,  // fully observed solvers
	L2R_WSABIE=20,  // multiclass rank estimation with length constraints + random sampling
	L2R_WSABIE2=21, // multiclass rank estimation with norm regularizaiton + random perumuation
	L2R_WSABIE3=22, // similar to L2R_WSABIE but with W = I (full rank, k = nr_feats)
	L2R_WSABIE4=23, // similar to L2R_WSABIE2 but with W = I (full rank, k = nr_feats)
