...
void matrix_matrix(double alpha, double *A, bool trans_A, double *B, bool trans_B, double beta, double *C, int m, int n, int k) {
...
void doVM(double alpha, double *V, double *M, double beta, double *VM, int n, int k) {
	bool transpose = true;
