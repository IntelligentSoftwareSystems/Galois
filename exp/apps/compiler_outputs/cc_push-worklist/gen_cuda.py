...
Invoke("InitializeGraph", ("ctx->gg", "ctx->nowned", "__begin", "__end", "ctx->comp_current.data.gpu_wr_ptr()")),
...
Invoke("ConnectedComp", ("ctx->gg", "ctx->nowned", "ctx->comp_current.data.gpu_wr_ptr()", "ctx->in_wl", "ctx->out_wl")),
CBlock(["check_cuda_kernel"], parse = False),
