...
Kernel("BFS", [G.param(), ('unsigned int', '__nowned'), ('unsigned int', '__begin'), ('unsigned int', '__end'), ('unsigned int *', 'p_dist_current'), ('unsigned int *', 'p_dist_old')],
[
ForAll("src", G.nodes("__begin", "__end"),
[
CDecl([("bool", "pop", " = src < __end")]),
...
CDecl([("dim3", "threads", "")]),
CBlock(["kernel_sizing(blocks, threads)"]),
Invoke("BFS", ("ctx->gg", "ctx->nowned", "__begin", "__end", "ctx->dist_current.gpu_wr_ptr()", "ctx->dist_old.gpu_wr_ptr()"), "SUM"),
CBlock(["check_cuda_kernel"], parse = False),
