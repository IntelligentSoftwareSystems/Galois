...
Kernel("InitializeGraph", [G.param(), ('int ', 'nowned') , ('unsigned long', 'local_infinity'), ('int', 'local_src_node'), ('unsigned int *', 'p_dist_current')],
[
...
Kernel("BFS", [G.param(), ('int ', 'nowned') , ('unsigned int *', 'p_dist_current'), ('Any', 'any_retval')],
[
ForAll("src", G.nodes(None, "nowned"),
[
...
Kernel("InitializeGraph_cuda", [('int', 'local_src_node'), ('unsigned long', 'local_infinity'), ('struct CUDA_Context *', 'ctx')],
[
CDecl([("dim3", "blocks", "")]),
CDecl([("dim3", "threads", "")]),
...
Invoke("BFS", ("ctx->gg", "ctx->nowned", "ctx->dist_current.gpu_wr_ptr()", "ctx->any_retval")),
CBlock(["check_cuda_kernel"], parse = False),
