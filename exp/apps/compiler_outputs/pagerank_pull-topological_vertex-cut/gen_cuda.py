...
Kernel("ResetGraph", [G.param(), ('unsigned int', 'nowned') , ('int *', 'p_nout'), ('float *', 'p_sum'), ('float *', 'p_value')],
[
...
Kernel("InitializeGraph", [G.param(), ('unsigned int', 'nowned') , ('const float ', 'local_alpha'), ('int *', 'p_nout'), ('float *', 'p_sum'), ('float *', 'p_value')],
[
ForAll("src", G.nodes(None, "nowned"),
[
...
Kernel("PageRank_partial", [G.param(), ('unsigned int', 'nowned') , ('int *', 'p_nout'), ('float *', 'p_sum'), ('float *', 'p_value')],
[
ForAll("src", G.nodes(None, "nowned"),
[
ClosureHint(
...
Kernel("PageRank", [G.param(), ('unsigned int', 'nowned') , ('const float ', 'local_alpha'), ('float', 'local_tolerance'), ('float *', 'p_sum'), ('float *', 'p_value'), ('Any', 'any_retval')],
[
ForAll("src", G.nodes(None, "nowned"),
[
...
Invoke("ResetGraph", ("ctx->gg", "ctx->nowned", "ctx->nout.gpu_wr_ptr()", "ctx->sum.gpu_wr_ptr()", "ctx->value.gpu_wr_ptr()")),
...
Kernel("PageRank_partial_cuda", [('struct CUDA_Context *', 'ctx')],
[
CDecl([("dim3", "blocks", "")]),
CDecl([("dim3", "threads", "")]),
CBlock(["kernel_sizing(ctx->gg, blocks, threads)"]),
Invoke("PageRank_partial", ("ctx->gg", "ctx->nowned", "ctx->nout.gpu_wr_ptr()", "ctx->sum.gpu_wr_ptr()", "ctx->value.gpu_wr_ptr()")),
CBlock(["check_cuda_kernel"], parse = False),
], host = True),
...
Invoke("PageRank", ("ctx->gg", "ctx->nowned", "local_alpha", "local_tolerance", "ctx->sum.gpu_wr_ptr()", "ctx->value.gpu_wr_ptr()", "ctx->any_retval")),
CBlock(["check_cuda_kernel"], parse = False),
