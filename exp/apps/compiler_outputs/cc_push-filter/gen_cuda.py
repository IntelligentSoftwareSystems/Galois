...
Kernel("ConnectedComp", [G.param(), ('unsigned int', '__nowned'), ('unsigned int', '__begin'), ('unsigned int', '__end'), ('unsigned int *', 'p_comp_current'), ('unsigned int *', 'p_comp_old'), ('Sum', 'sum_retval')],
[
ForAll("src", G.nodes("__begin", "__end"),
[
CDecl([("bool", "pop", " = src < __end")]),
...
Invoke("ConnectedComp", ("ctx->gg", "ctx->nowned", "__begin", "__end", "ctx->comp_current.gpu_wr_ptr()", "ctx->comp_old.gpu_wr_ptr()", "ctx->sum_retval")),
CBlock(["check_cuda_kernel"], parse = False),
