...
Kernel("InitializeGraph", [G.param(), ('int ', 'nowned') , ('unsigned long', 'local_offset'), ('unsigned int *', 'p_comp_current'), ('unsigned int *', 'p_comp_old')],
[
ForAll("src", G.nodes(None, "nowned"),
[
CBlock(["p_comp_current[src] = src + local_offset"]),
CBlock(["p_comp_old[src] = src + local_offset"]),
]),
]),
...
Kernel("InitializeGraph_cuda", [('unsigned long', 'local_offset'), ('struct CUDA_Context *', 'ctx')],
[
CDecl([("dim3", "blocks", "")]),
CDecl([("dim3", "threads", "")]),
CBlock(["kernel_sizing(ctx->gg, blocks, threads)"]),
Invoke("InitializeGraph", ("ctx->gg", "ctx->nowned", "local_offset", "ctx->comp_current.gpu_wr_ptr()", "ctx->comp_old.gpu_wr_ptr()")),
