...
Kernel("FirstItr_BFS", [G.param(), ('int ', 'nowned') , ('unsigned int *', 'p_dist_current'), ('unsigned int *', 'p_dist_old')],
[
ForAll("src", G.nodes(None, "nowned"),
[
...
CDecl([("dim3", "threads", "")]),
CBlock(["kernel_sizing(ctx->gg, blocks, threads)"]),
Invoke("FirstItr_BFS", ("ctx->gg", "ctx->nowned", "ctx->dist_current.gpu_wr_ptr()", "ctx->dist_old.gpu_wr_ptr()")),
CBlock(["check_cuda_kernel"], parse = False),
], host = True),
