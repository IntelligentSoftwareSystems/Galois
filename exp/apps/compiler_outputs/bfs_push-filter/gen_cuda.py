...
Kernel("FirstItr_BFS", [G.param(), ('unsigned int', '__nowned'), ('unsigned int', '__begin'), ('unsigned int', '__end'), ('unsigned int *', 'p_dist_current'), ('unsigned int *', 'p_dist_old')],
[
ForAll("src", G.nodes("__begin", "__end"),
[
CDecl([("bool", "pop", " = src < __end")]),
...
Kernel("BFS", [G.param(), ('unsigned int', '__nowned'), ('unsigned int', '__begin'), ('unsigned int', '__end'), ('unsigned int *', 'p_dist_current'), ('unsigned int *', 'p_dist_old'), ('Any', 'any_retval')],
[
ForAll("src", G.nodes("__begin", "__end"),
[
CDecl([("bool", "pop", " = src < __end")]),
...
Invoke("InitializeGraph", ("ctx->gg", "ctx->nowned", "__begin", "__end", "local_infinity", "local_src_node", "ctx->dist_current.gpu_wr_ptr()", "ctx->dist_old.gpu_wr_ptr()")),
...
CDecl([("dim3", "threads", "")]),
CBlock(["kernel_sizing(ctx->gg, blocks, threads)"]),
Invoke("FirstItr_BFS", ("ctx->gg", "ctx->nowned", "__begin", "__end", "ctx->dist_current.gpu_wr_ptr()", "ctx->dist_old.gpu_wr_ptr()")),
CBlock(["check_cuda_kernel"], parse = False),
], host = True),
Kernel("FirstItr_BFS_all_cuda", [('struct CUDA_Context *', 'ctx')],
[
CBlock(["FirstItr_BFS_cuda(0, ctx->nowned, ctx)"]),
], host = True),
...
Invoke("BFS", ("ctx->gg", "ctx->nowned", "__begin", "__end", "ctx->dist_current.gpu_wr_ptr()", "ctx->dist_old.gpu_wr_ptr()", "ctx->any_retval")),
CBlock(["check_cuda_kernel"], parse = False),
