...
Kernel("PageRank", [G.param(), ('unsigned int', '__nowned'), ('unsigned int', '__begin'), ('unsigned int', '__end'), ('const float ', 'local_alpha'), ('float', 'local_tolerance'), ('int *', 'p_nout'), ('float *', 'p_value'), ('Sum', 'sum_retval')],
[
CDecl([("float", "sum", "")]),
ForAll("src", G.nodes("__begin", "__end"),
[
...
Invoke("PageRank", ("ctx->gg", "ctx->nowned", "__begin", "__end", "local_alpha", "local_tolerance", "ctx->nout.gpu_wr_ptr()", "ctx->value.gpu_wr_ptr()", "ctx->sum_retval")),
CBlock(["check_cuda_kernel"], parse = False),
