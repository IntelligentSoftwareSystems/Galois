...
__global__ void batch_get_node_dist_old(index_type size, size_t * p_master_nodes, unsigned int * p_master_dist_old, unsigned int * p_dist_old) {
	unsigned tid = TID_1D;
	unsigned nthreads = TOTAL_THREADS_1D;
	index_type src_end = size;
	for (index_type src = 0 + tid; src < src_end; src += nthreads) {
...
__global__ void batch_get_reset_node_dist_old(index_type size, size_t * p_slave_nodes, unsigned int * p_slave_dist_old, unsigned int * p_dist_old, unsigned int value) {
	unsigned tid = TID_1D;
	unsigned nthreads = TOTAL_THREADS_1D;
	index_type src_end = size;
	for (index_type src = 0 + tid; src < src_end; src += nthreads) {
...
__global__ void batch_set_node_dist_old(index_type size, size_t * p_slave_nodes, unsigned int * p_slave_dist_old, unsigned int * p_dist_old) {
	unsigned tid = TID_1D;
	unsigned nthreads = TOTAL_THREADS_1D;
	index_type src_end = size;
	for (index_type src = 0 + tid; src < src_end; src += nthreads) {
...
__global__ void batch_add_node_dist_old(index_type size, size_t * p_master_nodes, unsigned int * p_master_dist_old, unsigned int * p_dist_old) {
	unsigned tid = TID_1D;
	unsigned nthreads = TOTAL_THREADS_1D;
	index_type src_end = size;
	for (index_type src = 0 + tid; src < src_end; src += nthreads) {
...
__global__ void batch_min_node_dist_old(index_type size, size_t * p_master_nodes, unsigned int * p_master_dist_old, unsigned int * p_dist_old) {
	unsigned tid = TID_1D;
	unsigned nthreads = TOTAL_THREADS_1D;
	index_type src_end = size;
	for (index_type src = 0 + tid; src < src_end; src += nthreads) {
