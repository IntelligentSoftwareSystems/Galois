...
int main(int argc, char** argv) {
  try {
   ...
   T_total.stop();
    ...
    std::cout << "[" << net.ID << "]" << " Total Time : " << T_total.get() << " Graph : " << T_graph_load.get() << " Init : " << T_init.get() << " bfs1 : " << T_bfs1.get() << " bfs2 : " << T_bfs2.get() << " bfs3 : " << T_bfs3.get() <<" bfs mean time : " << mean_time << "(msec)\n\n";
