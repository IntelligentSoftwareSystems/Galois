...
struct BFS {
  ...
  void static go(Graph& _graph){
    ...
    typedef dChunkedFIFO<64> dChunk;
      ...
      #endif
      Galois::for_each(_graph.begin(), _graph.end(), BFS { &_graph }, Galois::loopname("BFS"), Galois::write_set("sync_pull", "this->graph", "struct NodeData &", "struct NodeData &", "dist_current" , "int"),Galois::workList_version(), Get_info_functor<Graph>(_graph));
  }
