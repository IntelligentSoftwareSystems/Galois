...
Kernel("InitializeGraph", [G.param(), ('int ', 'nowned') , ('unsigned long', 'local_offset'), ('unsigned int *', 'p_comp_current')],
[
...
Kernel("ConnectedComp", [G.param(), ('int ', 'nowned') , ('unsigned int *', 'p_comp_current'), ('Any', 'any_retval')],
[
ForAll("src", G.nodes(None, "nowned"),
[
...
Invoke("InitializeGraph", ("ctx->gg", "ctx->nowned", "local_offset", "ctx->comp_current.gpu_wr_ptr()")),
