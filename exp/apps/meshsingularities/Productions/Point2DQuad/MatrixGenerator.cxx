...
std::vector<EquationSystem*>* MatrixGenerator::CreateMatrixAndRhs(TaskDescription& task_description)
{
		...
		Element** elements = CreateElements(bot_left_x,bot_left_y,size,nr_of_last_tier_elements,false);
...
{
	Element** elements = CreateElements(x, y, element_size, tier_size, first_tier);
...
Element** MatrixGenerator::CreateElements(double x, double y, double element_size, int size, bool first_tier)
{
	int i = 0;
	Element** elements = new Element*[size];
	double coordinates[4];
	bool neighbours[4]; neighbours[0] = true; neighbours[1] = true; neighbours[2] = true; neighbours[3] = true;
