...
INPUTS=("/workspace/roshan/inputs/scalefree/rmat16-2e15-a=0.57-b=0.19-c=0.19-d=.05.gr" "/workspace/roshan/inputs/scalefree/rmat16-2e20-a=0.57-b=0.19-c=0.19-d=.05.gr" "/workspace/roshan/inputs/road/USA-road-d.USA.gr" "/workspace/roshan/inputs/scalefree/rmat16-2e24-a=0.57-b=0.19-c=0.19-d=.05.gr" "/workspace/roshan/inputs/scalefree/rmat16-2e25-a=0.57-b=0.19-c=0.19-d=.05.gr")
