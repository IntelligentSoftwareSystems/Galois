...
if(DOXYGEN_FOUND)
	...
	find_package_handle_standard_args(DOXYFILE_IN DEFAULT_MSG "DOXYFILE_IN")
        set(UseDoxygen_FOUND FALSE CACHE BOOL "")
        if(UseDoxygen_FIND_VERSION)
          execute_process(COMMAND ${DOXYGEN_EXECUTABLE} --version OUTPUT_VARIABLE DOXYGEN_VERSION)
          if(DOXYGEN_VERSION VERSION_GREATER ${UseDoxygen_FIND_VERSION} OR DOXYGEN_VERSION VERSION_EQUAL ${UseDoxygen_FIND_VERSION})
            set(UseDoxygen_FOUND TRUE)
          else()
            if(UseDoxygen_FIND_REQUIRED)
              message(SEND_ERROR "Unable to find required doxygen version ${DOXGEN_VERSION} < ${UseDoxygen_FIND_VERSION}")
            endif()
          endif()
        else()
          set(UseDoxygen_FOUND TRUE)
...
if(DOXYGEN_FOUND AND DOXYFILE_IN_FOUND AND UseDoxygen_FOUND)
