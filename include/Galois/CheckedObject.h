...
public:
  ...
  T& get(Galois::MethodFlag m = MethodFlag::WRITE_INTENT) {
    Galois::Runtime::acquire(this, m);
    return val;
  }

  const T& get(Galois::MethodFlag m = MethodFlag::WRITE_INTENT) const {
...
public:
  void get(Galois::MethodFlag m = MethodFlag::WRITE_INTENT) const {
    Galois::Runtime::acquire(const_cast<GChecked*>(this), m);
  }
};
