...
public:
  ...
  typedef GWL_PQueue<T, Compare, true>  ConcurrentTy;
  typedef GWL_PQueue<T, Compare, false> SingleTy;
  enum {MAYSTEAL = concurrent};
  ...
  void push(T val) {
    threadsafe::simpleLock<int, concurrent>::lock();
    wl.push(val);
...
public:
  typedef GWL_LIFO<T, true>  ConcurrentTy;
  typedef GWL_LIFO<T, false> SingleTy;
  enum {MAYSTEAL = concurrent};
...
public:
  typedef GWL_LIFO_SB<T, true>  ConcurrentTy;
  typedef GWL_LIFO_SB<T, false> SingleTy;
  enum {MAYSTEAL = concurrent};
...
public:
  typedef GWL_FIFO<T, true>  ConcurrentTy;
  typedef GWL_FIFO<T, false> SingleTy;
  enum {MAYSTEAL = concurrent};
