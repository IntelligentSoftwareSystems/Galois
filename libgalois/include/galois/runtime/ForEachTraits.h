...
class ForEachTraits {
  ...
  typedef typename galois::DEPRECATED::special_decay<
      typename galois::DEPRECATED::special_decay<FunctionTy>::type>::type Fn;
...
struct ExtractForEachTraits {
  typedef typename true_indices<!ForEachTraits<FunctionTy>::NeedsAborts,
                                !ForEachTraits<FunctionTy>::NeedsStats,
                                !ForEachTraits<FunctionTy>::NeedsPush,
                                ForEachTraits<FunctionTy>::NeedsBreak,
                                ForEachTraits<FunctionTy>::NeedsPIA>::type
      NotDefault;
  typedef std::tuple<no_conflicts_tag, no_stats_tag, no_pushes_tag,
                     parallel_break_tag, per_iter_alloc_tag>
      Tags;
  typedef std::tuple<no_conflicts, no_stats, no_pushes, parallel_break,
                     per_iter_alloc>
      Values;
