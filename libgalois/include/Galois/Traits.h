...
struct indices_of_non_matching_tags_aux<Tuple, TagsTuple, I, Is...> {
  static const bool matches = Runtime::exists_by_supertype<typename std::tuple_element<I, TagsTuple>::type, Tuple>::value;
...
template<typename Tuple, typename TagsTuple, int I, int... Is>
struct indices_of_non_matching_tags<Tuple, TagsTuple, std::index_sequence<I, Is...> > {
  static const bool matches = Runtime::exists_by_supertype<typename std::tuple_element<I, TagsTuple>::type, Tuple>::value;
  typedef typename apply_indices_of_non_matching_tags<matches, Tuple, TagsTuple, I, Is...>::type type;
};
...
template<typename S, typename T, typename D,
         typename Seq = typename std::make_index_sequence<std::tuple_size<T>::value>::type,
  typename ResSeq = typename HIDDEN::indices_of_non_matching_tags<S,T,Seq>::type>
typename Runtime::tuple_elements<D, ResSeq>::type
