...
#include "Galois/Runtime/FixedSizeRing.h"
...
struct squeue {
  ...
  int myEffectiveID() { return Runtime::ThreadPool::getTID(); }
...
private:
  class Chunk : public Runtime::FixedSizeRing<T, ChunkSize>, public QT<Chunk, Concurrent>::ListNode {};
...
public:
  ...
  ChunkedMaster(unsigned numThreads, const std::tuple<WArgsTy...>&) { }
