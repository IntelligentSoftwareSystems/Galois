...
#ifndef GALOIS_RUNTIME_GDEQUE_H
#define GALOIS_RUNTIME_GDEQUE_H
...
template<typename T, unsigned ChunkSize=64, typename ContainerTy=Runtime::FixedSizeRing<T, ChunkSize> > 
class gdeque {
...
private:
  ...
  Runtime::FixedSizeAllocator<Block> heap;
