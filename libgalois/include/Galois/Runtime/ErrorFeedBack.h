...
namespace detail {
void printFatal(const std::string&) __attribute__ ((noreturn));
...
inline void gDie(const char* str) {
  detail::printFatal(str);
}
...
inline void gWarn(const char* str) {
  detail::printWarning(str);
}
