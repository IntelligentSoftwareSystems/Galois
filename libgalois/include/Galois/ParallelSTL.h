...
InputIterator find_if(InputIterator first, InputIterator last, Predicate pred)
{
  ...
  for_each(Runtime::make_no_deref_iterator(first), Runtime::make_no_deref_iterator(last), helper, Galois::wl<WL>());
...
struct map_reduce_helper {
  Runtime::PerThreadStorage<T>& init;
  MapFn fn;
  ReduceFn reduce;
  map_reduce_helper(Runtime::PerThreadStorage<T>& i, MapFn fn, ReduceFn reduce)
