...
void AbstractGraph::find_automorphisms(Stats& stats, void (*hook)(void *user_param, unsigned int n, const unsigned int *aut), void *user_param) {
	report_hook = hook;
...
const unsigned * AbstractGraph::canonical_form(Stats& stats, void (*hook)(void *user_param, unsigned int n, const unsigned int *aut), void *user_param) {
	report_hook = hook;
	report_user_param = user_param;
	search(true, stats);
...
#ifdef USE_DOMAIN
void Graph::Vertex::add_edge(const unsigned other_vertex, Index index) {
	edges.push_back(std::make_pair(other_vertex, index));
#else
void Graph::Vertex::add_edge(const unsigned other_vertex) {
 ...
 * Time complexity: O(1)
 */
unsigned Graph::vertex_color_invariant(const Graph* const g, const unsigned int v) {
 ...
 * Time complexity: O(1)
 */
unsigned Graph::degree_invariant(const Graph* const g, const unsigned int v) {
 ...
 */
unsigned Graph::selfloop_invariant(const Graph* const g, const unsigned int v) {
