...
public:
	...
	void find_automorphisms(Stats& stats, 
			void (*hook)(void* user_param, unsigned int n, const unsigned int* aut), void* hook_user_param);
...
protected:
	...
	bool nucr_find_first_component(const unsigned int level, std::vector<unsigned int>& component,
