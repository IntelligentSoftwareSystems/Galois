...
static inline void ALL_DEBUG(void) { DEBUG_CATEGORY = DEBUG_ALL; }
...
#define ASSERT(EXPR)                                                           \
  {                                                                            \
    if (!(EXPR)) {                                                             \
      fprintf(stdout,                                                          \
              ERROR "FAILED ASSERTION" CLEAR ": '" #EXPR                       \
                    "' at %s() in %s:%d\n",                                    \
...
#define ASSERT_MSG(EXPR, MESSAGE)                                              \
  {                                                                            \
    if (!(EXPR)) {                                                             \
      fprintf(stdout,                                                          \
              ERROR "FAILED ASSERTION: %s" CLEAR " '" #EXPR                    \
                    "' at %s() in %s:%d.\n",                                   \
...
#define ERROR_XMSG(EXPR, MESSAGE)                                              \
  {                                                                            \
    fprintf(stdout,                                                            \
            ERROR "ERROR: %s" CLEAR                                            \
                  " at %s() in %s:%d. Expr '%s' has value: '%d'.\n",           \
