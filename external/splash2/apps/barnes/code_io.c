...
void output(ProcessId) unsigned int ProcessId;
{
...
void diagnostics(ProcessId) unsigned int ProcessId;
{
...
void in_int(str, iptr) stream str;
int* iptr;
{
...
void in_real(str, rptr) stream str;
real* rptr;
{
  double tmp;
...
void in_vector(str, vec) stream str;
vector vec;
{
...
void out_int(str, ival) stream str;
int ival;
{ fprintf(str, "  %d\n", ival); }

void out_real(str, rval) stream str;
real rval;
{ fprintf(str, " %21.14E\n", rval); }

void out_vector(str, vec) stream str;
vector vec;
{
