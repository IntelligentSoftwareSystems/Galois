...
initparam(argv, defv) string* argv, *defv;
{ defaults = defv; }
...
string getparam(name) string name; /* name of parameter */
{
...
int getiparam(name) string name; /* name of parameter */
{
  string getparam(), val;
  int atoi();
...
long getlparam(name) string name; /* name of parameter */
{
  string getparam(), val;
  long atol();
...
bool getbparam(name) string name; /* name of parameter */
{
  string getparam(), val;
...
double getdparam(name) string name; /* name of parameter */
{
  string getparam(), val;
  double atof();
...
int scanbind(bvec, name) string bvec[];
string name;
{
  int i;
  bool matchname();
...
bool matchname(bind, name) string bind, name;
{
  char *bp, *np;
...
string extrvalue(arg) string arg; /* string of the form "name=value" */
{
  char* ap;
